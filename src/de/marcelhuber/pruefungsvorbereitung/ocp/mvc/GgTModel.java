...
//        Programmstart erwünscht
        ...
        System.out.println("\n\n");
        String[] argsAB = {"" + a, "" + b};
        new GgTModel().go(argsAB);
        ggTEuclid = new GgTModel().ggTEuclidExtended(a, b);
        x = ggTEuclid[0];
        y = ggTEuclid[1];
        ggT = ggTEuclid[2];
        ...
        System.out.println(x + " * (" + a + ") + (" + y + ") * (" + b + ") "
                + "ist " + kontrolle + "\n"
                + "          und der ggT ist " + ggT);
        System.out.println(new GgTModel().ggTEuclid(a, b));
        System.out.println(new GgTModel().ggTNaiv(a, b));
    }
