 ...
 * @author Marcel Huber
 */
public class GgTModelCalculator {
...
//        Programmstart erwünscht
        new GgTModelCalculator().go(args);
        long x, y, ggT;
        long[] ggTEuclid;
        long a = 24, b = 72;
        System.out.println("\n\n");
        ...
        System.out.println("\n\n");
        String[] argsAB = {"" + a, "" + b};
        new GgTModelCalculator().go(argsAB);
        ggTEuclid = new GgTModelCalculator().ggTEuclidExtended(a, b);
        x = ggTEuclid[0];
        y = ggTEuclid[1];
        ggT = ggTEuclid[2];
        ...
        System.out.println(x + " * (" + a + ") + (" + y + ") * (" + b + ") "
                + "ist " + kontrolle + "\n"
                + "          und der ggT ist " + ggT);
        System.out.println(new GgTModelCalculator().ggTEuclid(a, b));
        System.out.println(new GgTModelCalculator().ggTNaiv(a, b));
    }
