...
public class DecTogAddisch {
    ...
    private void go() {
        ...
        hinweis();
        gBase = readGBase();
        List<List<Long>> exponentenZiffern;
        exponentenZiffern = calculateDecTogAddisch(Math.abs(decNumber), gBase);
        Long[] exponentenAlsArray = new Long[exponentenZiffern.get(0).size()];
        exponentenZiffern.get(0).toArray(exponentenAlsArray);
        Long[] ziffernAlsArray = new Long[exponentenZiffern.get(1).size()];
        exponentenZiffern.get(1).toArray(ziffernAlsArray);
...
//        System.out.println("Ziffer: "+exponentUndZiffer[1]);
    ...
    public List<List<Long>> calculateDecTogAddisch(long dec, long g) {
//        List<Long>[] exponentenZiffernListe = new ArrayList[2];
        List<List<Long>> exponentenZiffernListe = new ArrayList<>(); // besser dieses verwenden, siehe Seite 372/373
        // in https://www.uni-trier.de/fileadmin/urt/doku/java/v80/java8.pdf
...
//            PressEnter.toContinue();
        ...
        exponentenZiffernListe.add(exponenten);
        exponentenZiffernListe.add(ziffern);
...
//        System.out.println(Arrays.toString(testArray));
    ...
    public long[][] calculateDecTogAddischAsArray(long dec, long g) {
        ...
        List<List<Long>> exponentenZiffern = calculateDecTogAddisch(dec, g);
...
//        das Array!
        Long[] helpArray = new Long[exponentenZiffern.get(0).size()];
        exponentenZiffern.get(0).toArray(helpArray);
        exponentenZiffernArraysL[0] = helpArray;
        helpArray = new Long[exponentenZiffern.get(1).size()];
        exponentenZiffern.get(1).toArray(helpArray);
...
//// Alte Version der DecTogAddisch-Klasse, deswegen auskommentiert
//// müsste auch in DecTogAddisch_old gespeichert werden
//package de.marcelhuber.mathematik;
//
//import de.marcelhuber.systemtools.ReadInput;
//import de.marcelhuber.mathematischeHilfsprogramme.LongArray;
...
// * @author Marcel Huber
// */
//public class DecTogAddisch_old {
//
//    private long decNumber;
//    private long gBase;
//
//    public static void main(String[] args) {
//        new DecTogAddisch_old().go();
//    }
//
//    private void go() {
//        System.out.println("Geben Sie die Zahl (ohne Leerzeichen) in "
...
//        List<Long>[] exponentenZiffernListe = new ArrayList[2];
////        List<List<Long>> exponentenZiffernListe; // besser dieses verwenden, siehe Seite 372/373
//                                                   // in https://www.uni-trier.de/fileadmin/urt/doku/java/v80/java8.pdf
////        exponentenZiffernListe[0] = new ArrayList<Long>();
////        exponentenZiffernListe[1] = new ArrayList<Long>();
//        List<Long> ziffern = new ArrayList<>();
